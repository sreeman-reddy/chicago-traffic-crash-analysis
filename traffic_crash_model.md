...
![](traffic_crash_model_figures/unnamed-chunk-7-1.png)<!-- -->
...
![](traffic_crash_model_figures/unnamed-chunk-7-2.png)<!-- -->
...
```
    ...
    ##   NO INDICATION OF INJURY     688                 10196                  751970
    ##   NONINCAPACITATING INJURY    279                  4659                    6185
    ##   REPORTED, NOT EVIDENT         0                     0                       0
    ##                           Reference
    ## Prediction                 NONINCAPACITATING INJURY REPORTED, NOT EVIDENT
    ##   FATAL                                           0                     0
    ##   INCAPACITATING INJURY                           0                     0
    ##   NO INDICATION OF INJURY                     52566                 33728
    ##   NONINCAPACITATING INJURY                    17289                  4826
    ...
    ## Sensitivity                                  0.24750
    ## Specificity                                  0.98037
    ## Pos Pred Value                               0.52016
    ## Neg Pred Value                               0.93810
    ## Precision                                    0.52016
    ## Recall                                       0.24750
    ## F1                                           0.33541
    ## Prevalence                                   0.07917
    ## Detection Rate                               0.01959
    ## Detection Prevalence                         0.03767
...
![](traffic_crash_model_figures/unnamed-chunk-9-1.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-2.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-3.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-4.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-5.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-6.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-7.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-8.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-9.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-10.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-11.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-12.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-13.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-14.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-15.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-16.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-17.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-18.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-19.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-9-20.png)<!-- -->
...
![](traffic_crash_model_figures/unnamed-chunk-14-1.png)<!-- -->
...
![](traffic_crash_model_figures/unnamed-chunk-14-2.png)<!-- -->
...
```
    ...
    ##   $500 OR LESS         18158          5147       10694
    ##   $501 - $1,500          399          1128        1151
    ##   OVER $1,500          80621        222483      542605
    ## 
    ## Overall Statistics
    ##                                           
    ##                Accuracy : 0.6368          
    ...
    ## Sensitivity                      0.18308             0.004931
    ## Specificity                      0.97977             0.997629
    ## Pos Pred Value                   0.53407             0.421210
    ## Neg Pred Value                   0.90450             0.741244
    ## Precision                        0.53407             0.421210
    ## Recall                           0.18308             0.004931
    ## F1                               0.27269             0.009748
    ## Prevalence                       0.11240             0.259249
    ## Detection Rate                   0.02058             0.001278
    ## Detection Prevalence             0.03853             0.003035
    ## Balanced Accuracy                0.58143             0.501280
    ##                      Class: OVER $1,500
    ## Sensitivity                     0.97864
    ## Specificity                     0.07572
    ## Pos Pred Value                  0.64160
    ## Neg Pred Value                  0.67705
    ## Precision                       0.64160
    ## Recall                          0.97864
    ## F1                              0.77506
    ## Prevalence                      0.62835
    ## Detection Rate                  0.61493
    ## Detection Prevalence            0.95843
    ## Balanced Accuracy               0.52718
...
![](traffic_crash_model_figures/unnamed-chunk-16-1.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-16-2.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-16-3.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-16-4.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-16-5.png)<!-- -->![](traffic_crash_model_figures/unnamed-chunk-16-6.png)<!-- -->
    ...
    ## Multi-class area under the curve: 0.6419
...
![](traffic_crash_model_figures/unnamed-chunk-21-1.png)<!-- -->
...
![](traffic_crash_model_figures/unnamed-chunk-25-1.png)<!-- -->
